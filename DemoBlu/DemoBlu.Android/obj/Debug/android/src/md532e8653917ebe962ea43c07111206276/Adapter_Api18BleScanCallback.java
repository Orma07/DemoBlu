package md532e8653917ebe962ea43c07111206276;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BLE.Android.Adapter+Api18BleScanCallback, Plugin.BLE, Version=1.2.1.0, Culture=neutral, PublicKeyToken=null", Adapter_Api18BleScanCallback.class, __md_methods);
	}
	...
	public Adapter_Api18BleScanCallback () throws java.lang.Throwable
	{
		...
		if (getClass () == Adapter_Api18BleScanCallback.class)
			mono.android.TypeManager.Activate ("Plugin.BLE.Android.Adapter+Api18BleScanCallback, Plugin.BLE, Version=1.2.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
